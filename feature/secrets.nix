...
let
  ...
  hostsecrets = "${config.host.feature.secrets.secretsBasePath}/hosts/${hostName}/secrets/secrets.yaml";
  commonsecrets = "${config.host.feature.secrets.secretsBasePath}/hosts/common/secrets/secrets.yaml";
